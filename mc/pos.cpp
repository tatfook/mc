...
namespace mc_map {
	...
	extern const mc_map::BlockPos DIR_SOUTH(0, 1, 0);
	extern const mc_map::BlockPos DIR_EAST(1, 0, 0);
	extern const mc_map::BlockPos DIR_WEST(-1, 0, 0);
	extern const mc_map::BlockPos DIR_TOP(0, 0, 1);
	extern const mc_map::BlockPos DIR_BOTTOM(0, 0, -1);
